...
(** Abstract type of LTL (contains pElo2 connectives as well as basic counting
    capabilities).  *)
module type LTL = sig
...
module type MODEL = sig
  ...
  type t = private {
    elo : Elo2.t;   
    init : (string * ltl) Sequence.t; (* fst: string repr of Elo2 formula *)
    invariant : (string * ltl) Sequence.t; (* fst: string repr of Elo2 formula *)
    trans : (string * ltl) Sequence.t; (* fst: string repr of Elo2 formula *)
    property : string * ltl                (* fst: string repr of Elo2 formula *)
  }
