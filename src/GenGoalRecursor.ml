...
class virtual ['self] recursor =
  object (self : 'self)
    ...
    method visit_Sat env _visitors_c0 =
      let _visitors_r0 = self#visit_list self#visit_fml env _visitors_c0
      in
      self#build_Sat env _visitors_c0 _visitors_r0
    method visit_t env _visitors_this =
      match _visitors_this with
        | Sat _visitors_c0 -> self#visit_Sat env _visitors_c0
    ...
    method visit_sim_binding env (_visitors_c0,_visitors_c1,_visitors_c2)
      ...
      let _visitors_r1 =
        self#visit_list self#visit_'v env _visitors_c1  in
      let _visitors_r2 = self#visit_exp env _visitors_c2  in
      (_visitors_r0, _visitors_r1, _visitors_r2)
    method visit_disj env _visitors_this = _visitors_this
