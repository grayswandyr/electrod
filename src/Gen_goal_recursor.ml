...
class virtual ['self] recursor =
  object (self : 'self)
    ...
    method visit_RComp env _visitors_c0 _visitors_c1 _visitors_c2 =
      ...
      self#build_RComp env _visitors_c0 _visitors_c1 _visitors_c2 _visitors_r0
    ...
    method visit_IComp env _visitors_c0 _visitors_c1 _visitors_c2 =
      ...
      self#build_IComp env _visitors_c0 _visitors_c1 _visitors_c2 _visitors_r0
        _visitors_r1 _visitors_r2
    ...
    method visit_LBin env _visitors_c0 _visitors_c1 _visitors_c2 =
      ...
      self#build_LBin env _visitors_c0 _visitors_c1 _visitors_c2 _visitors_r0
        _visitors_r1 _visitors_r2
    ...
    method visit_Quant env _visitors_c0 _visitors_c1 _visitors_c2 =
      ...
      self#build_Quant env _visitors_c0 _visitors_c1 _visitors_c2 _visitors_r0
        _visitors_r1 _visitors_r2
    ...
    method visit_FIte env _visitors_c0 _visitors_c1 _visitors_c2 =
      ...
      let _visitors_r1 = self#visit_fml env _visitors_c1 in
      let _visitors_r2 = self#visit_fml env _visitors_c2 in
      self#build_FIte env _visitors_c0 _visitors_c1 _visitors_c2 _visitors_r0
        _visitors_r1 _visitors_r2
    ...
    method visit_prim_fml env _visitors_this =
      match _visitors_this with
      | True -> self#visit_True env
      | False -> self#visit_False env
      ...
      | Block _visitors_c0 -> self#visit_Block env _visitors_c0
    ...
    method visit_lbinop env _visitors_this =
      match _visitors_this with
      | And -> self#visit_And env
      | Or -> self#visit_Or env
      | Imp -> self#visit_Imp env
      | Iff -> self#visit_Iff env
      | U -> self#visit_U env
      | R -> self#visit_R env
      | S -> self#visit_S env
      | T -> self#visit_T env
    ...
    method visit_comp_op env _visitors_this =
      match _visitors_this with
      | In -> self#visit_In env
      | NotIn -> self#visit_NotIn env
      | REq -> self#visit_REq env
      | RNEq -> self#visit_RNEq env
    ...
    method visit_icomp_op env _visitors_this =
      match _visitors_this with
      | IEq -> self#visit_IEq env
      | INEq -> self#visit_INEq env
      | Lt -> self#visit_Lt env
      | Lte -> self#visit_Lte env
      | Gt -> self#visit_Gt env
      | Gte -> self#visit_Gte env
    ...
    method visit_RBin env _visitors_c0 _visitors_c1 _visitors_c2 =
      ...
      let _visitors_r2 = self#visit_exp env _visitors_c2 in
      self#build_RBin env _visitors_c0 _visitors_c1 _visitors_c2 _visitors_r0
        _visitors_r1 _visitors_r2
    ...
    method visit_RIte env _visitors_c0 _visitors_c1 _visitors_c2 =
      ...
      let _visitors_r1 = self#visit_exp env _visitors_c1 in
      let _visitors_r2 = self#visit_exp env _visitors_c2 in
      self#build_RIte env _visitors_c0 _visitors_c1 _visitors_c2 _visitors_r0
        _visitors_r1 _visitors_r2
    ...
    method visit_prim_exp env _visitors_this =
      ...
      | Univ -> self#visit_Univ env
      | Iden -> self#visit_Iden env
      | Ident _visitors_c0 -> self#visit_Ident env _visitors_c0
      | RUn (_visitors_c0, _visitors_c1) ->
          self#visit_RUn env _visitors_c0 _visitors_c1
    ...
    method visit_rqualify env _visitors_this =
      match _visitors_this with
      | ROne -> self#visit_ROne env
      | RLone -> self#visit_RLone env
      | RSome -> self#visit_RSome env
      | RNo -> self#visit_RNo env
    ...
    method visit_runop env _visitors_this =
      match _visitors_this with
      | Transpose -> self#visit_Transpose env
      | TClos -> self#visit_TClos env
      | RTClos -> self#visit_RTClos env
    ...
    method visit_rbinop env _visitors_this =
      match _visitors_this with
      | Union -> self#visit_Union env
      | Inter -> self#visit_Inter env
      | Over -> self#visit_Over env
      | LProj -> self#visit_LProj env
      | RProj -> self#visit_RProj env
      | Prod -> self#visit_Prod env
      | Diff -> self#visit_Diff env
    ...
    method visit_prim_iexp env _visitors_this =
      ...
      | Card _visitors_c0 -> self#visit_Card env _visitors_c0
