...
module Make_SMV_LTL :
  functor (At : Solver.ATOMIC_PROPOSITION) -> Solver2.LTL with module Atomic = At

(** TODO: implement abstract file format functions  *)
module Make_SMV_file_format : functor (Ltl : Solver2.LTL)
  -> Solver2.MODEL with type ltl = Ltl.t and type atomic = Ltl.Atomic.t
