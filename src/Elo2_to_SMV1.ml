...
module SMV_LTL = SMV2.Make_SMV_LTL(SMV_atom)

module SMV_file_format = SMV2.Make_SMV_file_format(SMV_LTL)

module Elo_to_SMV_LTL = Elo2_to_ltl2.Make(SMV_LTL)

module Elo_to_SMV_model = Elo2_to_model1.Make(SMV_LTL)(Elo_to_SMV_LTL)(SMV_file_format)
