...
type ident = Var of Var.t | Name of Name.t
...
let substitute =
  object (_ : 'self)
    ...
    method! visit_Ident (env : (Var.t, (var, ident) G.prim_exp) CCList.Assoc.t)
        (id : ident) =
      (* Msg.debug *)
...
let rename =
  object (_ : 'self)
    ...
    method! visit_Ident (relation_renaming : (Name.t, Name.t) List.Assoc.t)
        (id : ident) =
      match id with
      | Name name ->
